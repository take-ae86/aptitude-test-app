...
import '../../logic/ratio_engine.dart';

class SpiRatioPage extends StatefulWidget {
  const SpiRatioPage({super.key});

  @override
  State<SpiRatioPage> createState() => _SpiRatioPageState();
}

class _SpiRatioPageState extends State<SpiRatioPage> {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('割合・比・分割払い・仕事算', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
