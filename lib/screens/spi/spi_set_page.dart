...
import '../../logic/set_engine.dart';

class SpiSetPage extends StatefulWidget {
  const SpiSetPage({super.key});

  @override
  State<SpiSetPage> createState() => _SpiSetPageState();
}

class _SpiSetPageState extends State<SpiSetPage> {
  final SetEngine _engine = SetEngine();
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('集合', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
  ...
  Widget _buildResultView() {
    ...
    if (percentageInt == 100) {
      ...
      gaugeColor = Colors.pink; // or Colors.orange for 40%
    } else if (percentageInt >= 20) {
      gaugeColor = Colors.red; // or Colors.orange
    } else {
