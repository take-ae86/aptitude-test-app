...
import '../../logic/ordering_engine.dart';

class SpiOrderingPage extends StatefulWidget {
  const SpiOrderingPage({super.key});

  @override
  State<SpiOrderingPage> createState() => _SpiOrderingPageState();
}

class _SpiOrderingPageState extends State<SpiOrderingPage> {
  final OrderingEngine _engine = OrderingEngine();
  List<OrderingProblem> _problems = [];
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('文の並び換え', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
              ...
              children: [
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("文中のアからエの空欄に、AからDの語句を入れて文を完成させる場合、最も適切な組み合わせを答えなさい。", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8), // 12 -> 8
                        Text(
                          "${problem.questionPrefix.trim()}\n(ア) (イ) (ウ) (エ)\n${problem.questionSuffix.trim()}",
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildDefinitionRow("A", problem.options["A"]!),
                      _buildDefinitionRow("B", problem.options["B"]!),
                      _buildDefinitionRow("C", problem.options["C"]!),
                      _buildDefinitionRow("D", problem.options["D"]!),
                    ],
                  ),
                ),
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 12), // 8 -> 8 (維持)
                      ...
                      child: RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: _formatOrderString(opt.answers),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("${problem.questionPrefix}...${problem.questionSuffix}", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 8),
