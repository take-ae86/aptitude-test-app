...
import '../../logic/probability_engine.dart';

class SpiProbabilityPage extends StatefulWidget {
  const SpiProbabilityPage({super.key});

  @override
  State<SpiProbabilityPage> createState() => _SpiProbabilityPageState();
}

class _SpiProbabilityPageState extends State<SpiProbabilityPage> {
  final ProbabilityEngine _engine = ProbabilityEngine();
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('確率', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
