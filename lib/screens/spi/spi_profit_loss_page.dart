...
import '../../logic/profit_loss_engine.dart';

class SpiProfitLossPage extends StatefulWidget {
  const SpiProfitLossPage({super.key});

  @override
  State<SpiProfitLossPage> createState() => _SpiProfitLossPageState();
}

class _SpiProfitLossPageState extends State<SpiProfitLossPage> {
  final ProfitLossEngine _engine = ProfitLossEngine();
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('損益算・料金の割引・代金の精算', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
