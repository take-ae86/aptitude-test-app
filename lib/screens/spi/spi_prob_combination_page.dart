...
import '../../logic/prob_combination_engine.dart';

class SpiProbCombinationPage extends StatefulWidget {
  const SpiProbCombinationPage({super.key});

  @override
  State<SpiProbCombinationPage> createState() => _SpiProbCombinationPageState();
}

class _SpiProbCombinationPageState extends State<SpiProbCombinationPage> {
  final ProbCombinationEngine _engine = ProbCombinationEngine();
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('順列・組み合わせ', style: TextStyle(fontSize: 16)),
          actions: [
            if (!_isLoading)
              Container(
