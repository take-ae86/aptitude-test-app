...
import '../../logic/arithmetic_engine.dart';

class CabArithmeticPage extends StatefulWidget {
  const CabArithmeticPage({super.key});

  @override
  State<CabArithmeticPage> createState() => _CabArithmeticPageState();
}

class _CabArithmeticPageState extends State<CabArithmeticPage> {
  final ArithmeticEngine _engine = ArithmeticEngine();
  List<ArithmeticProblem> _problems = [];
  ...
  Future<void> _startQuiz() async {
    ...
    try {
      // 5問生成
      final problems = _engine.generateProblems(5);
      if (mounted) {
        setState(() {
          _problems = problems;
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('四則演算', style: TextStyle(fontSize: 16)),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('第${_currentIndex + 1}問', style: TextStyle(color: Colors.green[900], fontWeight: FontWeight.bold, fontSize: 13)),
                ),
  ...
  Widget _buildResultView() {
    ...
    for (int i = 0; i < _problems.length; i++) {
      if (_userAnswers[i] == _problems[i].answer) correctCount++;
    }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.green, // CAB Color
                    foregroundColor: Colors.white,
                    elevation: 2,
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isCorrect = userAnswer == problem.answer;
                ...
                child: ExpansionTile(
                  ...
                  title: Row(
                    children: [
                      ...
                      Expanded(child: Text(problem.question, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis)),
                    ],
                  ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(userAnswer ?? "-", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: isCorrect ? Colors.green : Colors.red)),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Text(problem.answer, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.green)),
                            ],
                          ),
